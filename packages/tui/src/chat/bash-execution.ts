...
export class BashExecutionComponent extends Container {
	...
	constructor(command: string, ui: TUI, excludeFromContext = false) {
		...
		this.#ui = ui;
		// Host `bash.lineDisplay`, pushed through the display preferences; the tui
		// default (false) keeps the upstream character-by-character stream.
		this.#lineMode = chatTranscriptDisplayPreferences.lineDisplay;
